...
<xsl:function name="enopogues:get-form-title">
...
<xsl:function name="enopogues:get-name">
   ...
   <!--Not linked yet-->
<xsl:function name="enopogues:get-relevant">
      <xsl:param name="context" as="item()"/>
      <xsl:sequence select="enoddi:get-hideable-command($context)"/>
   </xsl:function>
   <!--Not linked yet-->
<xsl:function name="enopogues:get-readonly">
      <xsl:param name="context" as="item()"/>
   ...
   <!--Not linked yet-->
<xsl:function name="enopogues:get-calculate">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-calculate-label">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-calculate-alert">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-help">
      <xsl:param name="context" as="item()"/>
      <xsl:param name="language"/>
...
<xsl:function name="enopogues:get-appearance">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-header-columns">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-header-lines">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-body-lines">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-header-line">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-minimum-lines">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-constraint-dependencies">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-relevant-dependencies">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-readonly-dependencies">
      <xsl:param name="context" as="item()"/>
...
<xsl:function name="enopogues:get-code-depth">
      <xsl:param name="context" as="item()"/>
