...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:enopogues="http://xml.insee.fr/apps/eno/pogues" xmlns:d="ddi:datacollection:3_2"
    ...
    <xsl:function name="enopogues:get-hint">
    ...
    <xsl:function name="enopogues:get-alert">
        <xsl:param name="context" as="item()"/>
        <xsl:param name="language"/>
